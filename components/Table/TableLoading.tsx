...
export const TableLoading = () => {
  return (
    <div>
      <div className={'hidden w-full grid-cols-2 tablet:grid desktop:grid-cols-4'}>
      ...
      <div className={'flex flex-col divide-y divide-border'}>
        {[1, 2, 3, 4].map(el => (
          <div
            key={el}
            className={
              'flex w-full items-center justify-between p-4 tablet:grid tablet:grid-cols-2 desktop:grid-cols-4'
            }>
